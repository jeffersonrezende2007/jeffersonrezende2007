<h1 align="left">Jefferson Rezende</h1>

<p align="left">
  <strong>Estudante de Ciência da Computação | Dados • BI • Automação • Tecnologia</strong>
</p>
...
Sou estudante de **Ciência da Computação**, com experiência prática em **tecnologia, análise de dados, Business Intelligence, automação de processos e e-commerce**.

Tenho experiência com desenvolvimento de dashboards, relatórios gerenciais, organização de processos, análise financeira e automações utilizando Python.
...
### Ecom Fine — Estagiário de Tecnologia e Processos

**10/2024 – 03/2026**

Durante minha experiência profissional, atuei em atividades envolvendo tecnologia, dados e operações:

- Desenvolvimento de **dashboards em Power BI**
- Criação de **relatórios automatizados**
- Acompanhamento de indicadores de vendas e performance operacional
- Estruturação de relatórios financeiros, incluindo **DRE e fluxo de caixa**
- Validação e conciliação de dados de marketplaces
- Desenvolvimento de **automações em Python**
- Extração e organização de dados
- Participação em reuniões com empresários e tomadores de decisão
- Apoio em processos operacionais e triagem de candidatos

---

## Projetos

### MarketAdz & E-Fine Web

Projetos desenvolvidos dentro do ecossistema de soluções para **e-commerce**, envolvendo sistemas, dados, automação e processos operacionais.

O ecossistema chegou a atender **mais de 20 clientes e processar milhões de pedidos**.

**Principais áreas:**

`Análise de Dados` `Automação` `E-commerce` `Sistemas`  
`SQL` `Inteligência de Dados` `Engenharia de Prompt`
...
Buscando oportunidades de **Estágio ou Júnior** nas áreas de:

`Análise de Dados` `BI` `Processos` `Tecnologia`
